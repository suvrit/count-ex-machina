...
\begin{remark}[Scope]
The example is Schur-positive.  It does not refute AIM Problem 36.  Its lower endpoint inequalities also hold, so it does not refute Problem 37.  The full independent audit is included as \path{sources/stable_schur_counterexample_notes.pdf}.
\end{remark}
