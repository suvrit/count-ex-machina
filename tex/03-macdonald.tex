...
McSwiggen and Sahi normalize the Macdonald polynomial by
\[
\Omega_\lambda(x;q,t)=\frac{P_\lambda(x;q,t)}{P_\lambda(t^\delta;q,t)}
\]
and state that $\lambda\mapsto\Omega_\lambda(x;q,t)$ is Schur-convex on a scaled dominant $q$-lattice \cite{McSwiggenSahi2026}.
