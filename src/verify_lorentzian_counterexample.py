...
print("G(p), G(q), G(r):", G(p), G(q), G(r))
print("R_pq =", R_pq)
print("R_qr =", R_qr)
print("R_pr =", R_pr)
print("J(p,q) approximately", decimal_floor(J_pq[0]))
print("J(q,r) approximately", decimal_floor(J_qr[0]))
print("J(p,r) approximately", decimal_floor(J_pr[0]))
print("exact rational lower bound for triangle violation =", violation_lower)
print("decimal lower bound =", decimal_floor(violation_lower))
