...
\begin{cxrefutation}
Problem~\ref{ctx:osi-sketch-and-solve} asks whether one-sided injectivity
near $1$ yields the usual relative-error guarantee for sketch-and-solve
\cite{AmselEtAl2026}.  The
