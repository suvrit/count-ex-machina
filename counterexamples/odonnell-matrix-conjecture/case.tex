...
For every $C>0$ there exist an integer $n$ and a PSD matrix $R\in\mathbb R^{n\times n}$ with $\operatorname{tr}R=1$ such that, writing $D=\operatorname{Diag}(R)=\operatorname{diag}(d_1,\ldots,d_n)$ and listing the eigenvalues $\lambda_1\geq\cdots\geq\lambda_n$, 
\[
