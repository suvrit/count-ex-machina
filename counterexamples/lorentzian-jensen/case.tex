...
S.~Sra, standalone problem posed in 2012; formulation as recorded in \S1 of the case's \path{paper.tex}
\end{cxsource}
...
S.~Sra, standalone problem posed in 2019 as a Lorentzian generalization of the log-volume statement; formulation as recorded in \S1 of the case's \path{paper.tex}
\end{cxsource}
