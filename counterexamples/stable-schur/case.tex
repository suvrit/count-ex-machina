...
\begin{remark}[Scope]
The example is Schur-positive, and its lower endpoint inequalities hold, so it refutes neither Problem~\ref{ctx:aim-problem-36} nor Problem~\ref{ctx:aim-problem-37}; those require the positive-definite pencils of Theorems~\ref{thm:aim36} and~\ref{thm:aim37} below.  The full independent audit is included as \path{counterexamples/stable-schur/artifacts/}.
\end{remark}
\end{cxrefutation}
